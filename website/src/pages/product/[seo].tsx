...
const ProductGallerry = dynamic(() => import("@app/entities/product/ui/ProductDetail/Gallerry"));
const ProductVariants = dynamic(() => import("@app/widgets/product/ProductVariants"));
