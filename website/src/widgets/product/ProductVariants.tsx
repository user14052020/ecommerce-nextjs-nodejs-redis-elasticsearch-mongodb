...
import AddProductButton from "@app/entities/basket/ui/AddProductButton";
...
const ProductVariants = ({ data }: ProductVariantsProps) => {
   ...
   const getVariantPrice = (data: VariantProduct[]) => {
      if (data.length > 0) {
         ...
         return (
            <span>
               <PriceView
                  value={newData[0].price}
                  priceIcon={priceIcon}
                  priceType={priceType}
               />{" "}
               -{" "}
               <PriceView
                  value={newData[data.length - 1].price}
                  priceIcon={priceIcon}
                  priceType={priceType}
               />{" "}
            </span>
