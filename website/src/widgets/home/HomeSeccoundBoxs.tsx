...
import ProductCardHome from "@app/entities/product/ui/ProductCard/home";
...
}: HomeSeccoundBoxsProps) => {
   const swiperStyle = {
      ["--swiper-navigation-color" as string]: "#000",
      ["--swiper-pagination-color" as string]: "#000",
   } as CSSProperties;
