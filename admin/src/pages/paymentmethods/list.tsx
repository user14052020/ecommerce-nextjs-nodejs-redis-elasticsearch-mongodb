...
} from "@app/entities/paymentmethod/model/types";

const Default: NextPage<PaymentMethodsListProps> = ({ getData = [] }) => {
  const intl = useIntl();
  const [data, setData] = useState<PaymentMethodItem[]>(getData);
