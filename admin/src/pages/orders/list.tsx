...
const Default: NextPage<OrdersListProps> = ({ getData = [] }) => {
  const intl = useIntl();
  const [data, setData] = useState<OrderRecord[]>(getData);
  ...
  const columns: ColumnsType<OrderRecord> = [
    ...
    },
    {
      ...
      key: "total_price",
      render: (_text, record) =>
        (Number(record.total_price) + Number(record.cargo_price)).toLocaleString(),
    },
    {
