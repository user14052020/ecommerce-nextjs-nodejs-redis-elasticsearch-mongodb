...
import type {
  ...
  PriceAdd,
  SelectOption,
} from "@app/entities/order/model/types";
...
const Default = () => {
  ...
  const [productDataAll, setProductDataAll] = useState<OrderProductItem[]>([]);
  const [productsAdd, setProductsAdd] = useState<OrderProductItem | null>(null);
    ...
    axios
      ...
      .then((res) => {
        if (res.data.length > 0) {
          ...
          const products = res.data as OrderProductItem[];
